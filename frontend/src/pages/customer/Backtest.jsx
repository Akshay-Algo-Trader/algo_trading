...
function PnlBadge({ pct }) {
  const pos = pct >= 0
  return (
    <span className={`inline-flex items-center gap-0.5 font-semibold text-xs px-2 py-0.5 rounded-full ${
...
export default function Backtest() {
  ...
  // Separate page state per tab; reset on new result or tab change
    ...
    <div className="space-y-6">
        ...
        <div className="space-y-5">
          ...
          <div className="flex items-center justify-between">
            ...
            <span className={`text-xs font-semibold px-2 py-1 rounded-full ${
              result.strategy.candle_pattern?.direction === 'bearish'
          ...
          <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
            ...
            {activeTab === 'trades' && (
              trades.length === 0 ? (
                <div className="p-8 text-center text-gray-400 text-sm">
                  No trades executed — pattern conditions were never met in this period.
                </div>
              ) : (
                <>
                          ...
                          return (
                            <tr key={globalIdx} className="hover:bg-gray-50 transition-colors">
                              ...
                              <td className="px-4 py-3">
                                <span className={`text-xs font-medium px-2 py-0.5 rounded-full ${ex.cls}`}>{ex.text}</span>
                              </td>
            ...
            {activeTab === 'detections' && (
              detections.length === 0 ? (
                <div className="p-8 text-center text-gray-400 text-sm">
                  Pattern was not detected in this period.
                </div>
              ) : (
                <>
                  <div className="overflow-x-auto">
                        ...
                        {detSlice.map((d, i) => {
                          ...
                          return (
                            <tr key={globalIdx} className="hover:bg-gray-50 transition-colors">
                              ...
                              <td className={`px-4 py-3 font-mono text-xs font-bold ${bull ? 'text-green-700' : 'text-red-600'}`}>
      ...
      {!result && !loading && !error && (
        <div className="bg-white border border-dashed border-gray-300 rounded-xl p-12 text-center">
          ...
          <p className="text-sm font-semibold text-gray-700">Select a strategy and duration, then run backtest</p>
