...
class FvgZoneScanResult(db.Model):
    __tablename__ = 'fvg_zone_scan_results'

    id = db.Column(db.Integer, primary_key=True)
    fvg_config_id = db.Column(db.Integer, db.ForeignKey('fvg_zone_configs.id'), nullable=False, index=True)
    ...
    def to_dict(self):
        return {
            'id': self.id,
            'fvg_config_id': self.fvg_config_id,
    ...
    def __repr__(self):
        return f'<FvgZoneScanResult {self.instrument} {self.candle_size} {self.period_days}d>'
